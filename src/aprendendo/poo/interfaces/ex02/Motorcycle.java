...
public class Motorcycle extends Vehicle implements Motorized{
    int gasLiters = 100;
    public Motorcycle(String model, String brand, int year, double value) {
    ...
    public void fillUp() {
        if(gasLiters == 0) {
            System.out.println("Motorcycle stop in the gas station for fill up");
            gasLiters = 100;
        }else{
            System.out.println("Motorcycle have gas in the gas Tank");
        }
    }
}
